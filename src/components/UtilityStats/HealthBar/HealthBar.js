...
const HealthBar=(props)=>{
    return(
        <div className="flex flex-row w-1/3 rounded-md bg-gray-900 text-white p-2">
            <div className="flex ml-2 flex-col w-20 ">
                <button className="border-2 hover:bg-red-900 px-2 rounded border-red-900">Heal</button>
                <input className="my-2 rounded border-2 text-center bg-transparent border-red-900 w-full" type="number"/>
            ...
            <div className="w-20 mr-2">
                ...
                <input type="number" placeholder="--" className="bg-transparent text-lg text-center w-12"/>
            </div>
        </div>
    );
};
